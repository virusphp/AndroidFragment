    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_category) {
            ...
            if (mFragmentManager != null) {
                CategoryFragmen mCategoryFragment = new CategoryFragmen();
                FragmentTransaction mFragmentTranscation = mFragmentManager.beginTransaction();
                mFragmentTranscation.replace(R.id.frame_container, mCategoryFragment, CategoryFragmen.class.getSimpleName());
